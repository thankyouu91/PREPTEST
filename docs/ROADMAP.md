...
- [ ] Ngữ pháp câu điều kiện bậc C1–C2 (9 điểm còn lại theo hạn mức: đảo ngữ điều kiện `Had I known` / `Were it not for` / `Should you`, `but for`, `if it were not for`, thức giả định với `suggest`/`insist`/`it is essential that`, `lest`, điều kiện ngầm không có mệnh đề if, `otherwise` trong lập luận học thuật)
