...
| Bị động, tường thuật | `/prep/hoc/bi-dong/` | 13 điểm bậc A2–B2. Bị động: các thì, `by`-tác nhân (và khi nào bỏ), khuyết thiếu, động từ hai tân ngữ, `It is said that…`, `have/get something done`. Tường thuật: câu kể, câu hỏi, mệnh lệnh, chuyển đại từ và trạng ngữ, **khi nào KHÔNG lùi thì**, mẫu câu của động từ tường thuật. Bậc C1–C2 soạn ở lượt sau |
