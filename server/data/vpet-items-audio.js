...
const PART_E = [
  ...
  ['vpet-e-27', 'B1', 'The delivery will arrive between two and four this afternoon.',
    'Two numbers in one sentence. Candidates who catch only one write a time that is half right and fully wrong.'],
  ['vpet-e-28', 'B1', 'Could you check whether the room is free on Friday?',
    '"whether" is unstressed and easy to hear as "weather", which spells differently and changes nothing else.'],
  ['vpet-e-29', 'B1', 'I have attached the report you asked for last week.',
    'A relative clause with no relative pronoun. The join at "report you" is where the sentence usually breaks.'],
  ['vpet-e-30', 'B1', 'The new staff member starts on the first of June.',
    'An ordinal spoken as "the first of" but often written as a numeral. Tests the written form, not the hearing.'],
  ['vpet-e-31', 'B1', 'We are still waiting for an answer from the supplier.',
    'Two unstressed prepositions in a row. "for an" reduces almost to one syllable in natural speech.'],
  ['vpet-e-32', 'B1', 'Please remember to bring your identity card with you.',
    'Ends on an unstressed "with you", which is the phrase most often dropped from a dictation.'],
  ['vpet-e-33', 'B1', 'The lift is out of order so please use the stairs.',
    'A fixed phrase and a result clause. Candidates who miss "out of order" usually invent a verb that fits.'],
  ['vpet-e-34', 'B1', 'She has worked in this department for almost ten years.',
    'Present perfect with "for". Writing "she worked" is the commonest error and is a grammar slip, not a hearing one.'],
  ['vpet-e-35', 'B1', 'There were fewer people at the workshop than we expected.',
    '"fewer" rather than "less" with a countable noun, and a comparative clause at the end.'],
  ['vpet-e-36', 'B1', 'The price does not include delivery or installation.',
    'Two long nouns in a row at the end, with no stress to separate them.'],
  ['vpet-e-37', 'B1', 'He asked me to remind you about the deadline tomorrow.',
    'A reported request with two objects. The chain "asked me to remind you" is where word order collapses.']
];
...
const PART_F = [
  ...
  ['vpet-f-27', 'B1', 'Shall I email you the details or print them?',
    ['Email is fine, thank you.',
      'Yes, I emailed it.',
      'About twenty pages.'],
    'Email is fine, thank you.',
    'An either-or offer wants one of the two chosen. "Yes" answers a question that was not asked.'],
  ['vpet-f-28', 'B1', 'The meeting has been put back to three.',
    ['I put it on your desk.',
      'That suits me better, actually.',
      'Yes, it was a good meeting.'],
    'That suits me better, actually.',
    '"Put back" means moved later, not returned. The trap answer treats it as the ordinary verb.'],
  ['vpet-f-29', 'B1', 'Have you had a chance to look at my draft?',
    ['It is on the third floor.',
      'Yes, I drew it myself.',
      'Not yet, I am sorry.'],
    'Not yet, I am sorry.',
    '"Had a chance to" is a softened have-you-done-it. A candidate who hears only "chance" answers about luck.'],
  ['vpet-f-30', 'B1', 'Could you tell me where the nearest bank is?',
    ['I banked there for years.',
      'Just past the traffic lights.',
      'At half past four.'],
    'Just past the traffic lights.',
    'An embedded question asking for a place. The time answer is the trap for anyone tracking only the polite opening.'],
  ['vpet-f-31', 'B1', 'I am afraid your card has been declined.',
    ['Let me try a different one.',
      'Thank you, I am not afraid.',
      'It is a birthday card.'],
    'Let me try a different one.',
    '"I am afraid" is a softener, not a statement about fear, and "card" here is not the paper kind.'],
  ['vpet-f-32', 'B1', 'Would Tuesday suit you better than Monday?',
    ['It suits you very well.',
      'Yes, it was on Tuesday.',
      'Either day is fine with me.'],
    'Either day is fine with me.',
    'A comparison between two days. "It suits you" answers the wrong sense of the verb suit.'],
  ['vpet-f-33', 'B1', 'Do you know how long the journey takes?',
    ['It is quite a long road.',
      'About two hours by bus.',
      'Yes, I know the way.'],
    'About two hours by bus.',
    '"How long" asks duration, not distance. "Yes, I know" answers the literal do-you-know and stops there.'],
  ['vpet-f-34', 'B1', 'I think there has been a mistake on this bill.',
    ['Let me have a look at it.',
      'Yes, the food was lovely.',
      'I paid it last week.'],
    'Let me have a look at it.',
    'A complaint delivered gently. The reply that fits offers to check, not to agree or to defend.'],
  ['vpet-f-35', 'B1', 'Thanks for staying late to finish that.',
    ['Yes, I am staying here.',
      'The bus leaves at eight.',
      'It was no trouble at all.'],
    'It was no trouble at all.',
    'Thanks wants a dismissal of the effort. The trap answers "staying" as though it were about accommodation.'],
  ['vpet-f-36', 'B1', 'Should I wait here or come back later?',
    ['I came back yesterday.',
      'Please take a seat, it will not be long.',
      'It is later than I thought.'],
    'Please take a seat, it will not be long.',
    'An either-or that a good reply resolves without repeating either option word for word.'],
  ['vpet-f-37', 'B1', 'Is it all right if I pay by transfer?',
    ['Yes, I will send you our details.',
      'It is not far to transfer.',
      'No, I have not paid.'],
    'Yes, I will send you our details.',
    'Asking permission to pay a particular way. Agreeing needs the next step, not just the word yes.'],
];
...
const PART_H = [
  ...
  ['vpet-h-33', 'B1', 'The shop opens at nine.',
    'Five words, all high frequency. Placed first so the added block does not open on a hard item.'],
  ['vpet-h-34', 'B1', 'I left my umbrella on the bus.',
    'Seven words with one concrete noun most candidates know. Measures pronunciation more than memory.'],
  ['vpet-h-35', 'B1', 'Could you send me the address again, please?',
    'A polite request with two objects. "send me the" is the run that gets compressed.'],
  ['vpet-h-36', 'B1', 'We have run out of paper for the printer.',
    'A three-word verb phrase. Candidates who reduce "run out of" to "run" lose the meaning entirely.'],
  ['vpet-h-37', 'B1', 'She said she would call before the end of the day.',
    'Eleven words, reported speech, one clause boundary. Backshifted "would" is often repeated as "will".'],
  ['vpet-h-38', 'B1', 'There is a small cafe on the corner near the station.',
    'Two prepositional phrases stacked at the end, which is where a repetition usually starts dropping words.'],
  ['vpet-h-39', 'B1', 'I did not realise the office closed so early on Fridays.',
    'A negative plus a that-clause with no "that". The join is the hard part, not the vocabulary.'],
  ['vpet-h-40', 'B1', 'The report needs to be finished before the meeting tomorrow.',
    'A passive infinitive. "needs to be finished" is commonly flattened to "needs finished".'],
  ['vpet-h-41', 'B1', 'My brother has been living in Da Nang since last March.',
    'Present perfect continuous with "since". The auxiliary chain is three words long and easy to shorten.'],
  ['vpet-h-42', 'B1', 'They are looking for someone who can speak both languages.',
    'A relative clause with a modal inside it. Ten words, no rare vocabulary.'],
  ['vpet-h-43', 'B1', 'If the train is late again, I will take a taxi.',
    'A first conditional across two clauses. Candidates often merge the tenses and say "will be late".'],
  ['vpet-h-44', 'B1', 'Nobody told me that the deadline had been moved forward.',
    'A negative subject plus a past perfect passive. The longest auxiliary chain in the B1 set.'],
  ['vpet-h-45', 'B1', 'Please make sure the door is locked when you leave.',
    'An imperative with an embedded clause. "make sure" is a fixed phrase that survives or fails whole.'],
  ['vpet-h-46', 'B1', 'The photographs from the trip are still on my old phone.',
    'A long subject with a prepositional phrase inside it, so the verb arrives late.']
];
...
const PART_J = [
  ...
  ['vpet-j-11', 'B1',
    'On her way to work one morning Linh found a wallet on the pavement outside the market. There was money inside and a card with a phone number, so she rang it and arranged to hand the wallet back at lunchtime. The owner turned out to be the woman who sold her coffee every day. Neither of them had known the other by name until then, and after that the coffee was always free.',
    'Four events in order with a closing detail that gives the story its point. A retelling that stops at the handover has reported the facts and dropped the ending.'],
  ['vpet-j-12', 'B1',
    'A man in an apartment block kept finding his rubbish bin moved from the corridor to the stairwell. He assumed a neighbour was complaining about the smell, so he began taking the bin down every evening instead. Weeks later he saw who was moving it: the caretaker, who could not get the floor polisher past it. Neither of them had ever mentioned the bin to the other.',
    'Tests whether the retelling keeps the wrong assumption before the reveal. Candidates who begin with the caretaker have thrown away the shape.'],
  ['vpet-j-13', 'B1',
    'A small bank branch was famous for its long queues, so the manager added a second counter. The queue got longer rather than shorter. When she watched for an afternoon she saw why: customers who had been waiting outside now came in, because the queue looked like it was moving. She kept the second counter and stopped worrying about the length of the line.',
    'A story where the result contradicts the expectation. A good retelling makes the reason explicit; a weak one reports only that the queue grew.'],
  ['vpet-j-14', 'B1',
    'On his first day at a new job Tuan was given a desk with a drawer he could not open. He did not want to ask on his first morning, so he worked around it for a week. When he finally mentioned it, three colleagues admitted they had never opened it either. The office manager brought a key from a cupboard, and inside were forty unopened letters addressed to somebody who had left in 2019.',
    'Five events and a punchline. The retelling has to hold the drawer as an open question until the end, which is where candidates usually give it away early.']
];
